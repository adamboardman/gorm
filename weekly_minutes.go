...
type WeeklyMinutes [7][2]int

func (w *WeeklyMinutes) String() string {
	return fmt.Sprintf(
		"{{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d}}",
		w[0][0], w[0][1], w[1][0], w[1][1], w[2][0], w[2][1], w[3][0], w[3][1], w[4][0], w[4][1], w[5][0], w[5][1], w[6][0], w[6][1])
}

func (w WeeklyMinutes) Value() (driver.Value, error) {
	return w.String(), nil
}

func (w *WeeklyMinutes) Scan(val interface{}) error {
